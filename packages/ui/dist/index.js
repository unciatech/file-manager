...
import { Slot, AlertDialog as AlertDialog$1 } from 'radix-ui';
...
function ButtonArrow({ icon: Icon = ChevronDown, className, ...props }) {
  return /* @__PURE__ */ jsx(Icon, { "data-slot": "button-arrow", className: cn("ms-auto -me-1", className), ...props });
}
...
export { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, AlertDialogPortal, AlertDialogTitle, AlertDialogTrigger, Button, ButtonArrow, buttonVariants, cn };
