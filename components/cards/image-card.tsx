...
import { FileMetaData, ImageMetaData } from "@/types/file-manager";
...
export function ImageCard({ file, metaData }: ImageCardProps) {
    if (file.url) {
        return (
            <img
                src={file.url}
...
export function ImageCardMetadata({ metaData }: { metaData: ImageMetaData | null }) {
