...
import { Trash2, Pencil, CheckCircle, Move, MoreVertical } from "lucide-react";
              ...
              <div className="absolute top-0 right-0 z-10 md:hidden" onClick={(e) => e.stopPropagation()}>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56 rounded-2xl shadow-xl bg-white/50 backdrop-blur-2xl border-gray-200">
                    <DropdownMenuItem onClick={handleEdit} className="text-sm font-medium rounded-t-xl">
                      <EditIcon className="size-6" />
                      Edit
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={handleSelectFile} className="text-sm font-medium">
